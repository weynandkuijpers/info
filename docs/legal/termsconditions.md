...
See the following link for used definitions: [https://github.com/threefoldtoken/legal/blob/master/definitions.md](https://github.com/threefoldtoken/legal/blob/master/definitions.md)
...
This Agreement is subject to the laws as specified in the contract who links to this document.  Any dispute which may arise between the Parties in relation to the validity, interpretation or execution of this Agreement will be submitted to the exclusive jurisdiction of the mentioned Courts in the Agreement.
